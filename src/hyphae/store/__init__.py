...
reads and `hp query` in models, and the `Store` handle that hands those repositories out — the
only reads any other package makes, since the driver never leaves this package."""
