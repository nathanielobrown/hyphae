...
def detail(*, item: Detail) -> Html:
    ...
    column crosses the wire whole (each spec's `whole` in `view/detail.py:DETAILS`). A head whose
    row said what it was written in is marked up in that syntax; the rest is prose.
