...
from hyphae.store.sessions import DESCRIBED_SESSIONS, SESSIONS, SHOWN
...
def worst_session_row_bytes() -> int:
    ...
    """
    said = library.load(DESCRIBED_SESSIONS)
    ...
    listed = heads(SHOWN, LIST_ITEM_HEAD) + heads(library.load(SESSIONS), LIST_ITEM_HEAD)
